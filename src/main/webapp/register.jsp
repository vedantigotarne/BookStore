                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="password-strength mt-2">
                                        ...
                                        <ul class="list-unstyled small text-muted">
                                            <li><i class="fas fa-check-circle text-success me-2 d-none" id="length-check"></i>At least 8 characters</li>
                                            <li><i class="fas fa-check-circle text-success me-2 d-none" id="uppercase-check"></i>At least 1 uppercase letter</li>
                                            <li><i class="fas fa-check-circle text-success me-2 d-none" id="lowercase-check"></i>At least 1 lowercase letter</li>
                                            <li><i class="fas fa-check-circle text-success me-2 d-none" id="number-check"></i>At least 1 number</li>
                                            <li><i class="fas fa-check-circle text-success me-2 d-none" id="special-check"></i>At least 1 special character</li>
                                        </ul>
                                    </div>
                                </div>
	 ...
	 // Enable Bootstrap validation styling
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            password.addEventListener('input', function() {
                ...
                // Check uppercase
                if (/[A-Z]/.test(value)) {
                    uppercaseCheck.classList.remove('d-none');
                } else {
                    uppercaseCheck.classList.add('d-none');
                }
                
                // Check lowercase
                if (/[a-z]/.test(value)) {
                    lowercaseCheck.classList.remove('d-none');
                } else {
                    lowercaseCheck.classList.add('d-none');
                }
                
                // Check number
                if (/\d/.test(value)) {
                    numberCheck.classList.remove('d-none');
                } else {
                    numberCheck.classList.add('d-none');
                }
                
                // Check special character
                if (/[@$!%*?&]/.test(value)) {
                    specialCheck.classList.remove('d-none');
                } else {
                    specialCheck.classList.add('d-none');
                }
            });
